...
def test_division():
    ...
    Ejercicio 8 & 9: Este test inicialmente fallaba para demostrar
    las opciones de debugging de pytest (-v, --showlocals, --pdb).
    Ahora ha sido corregido después de usar PDB para inspeccionar variables.
    """
    # Variables locales para observar con --showlocals
    numerator = 10
    denominator = 2
    expected_result = 5  # ✅ CORREGIDO: 10 / 2 = 5 (antes era 4)

    # Realizar la división
    actual_result = numerator / denominator

    # Esta aserción ahora pasa correctamente
...
def test_multiplication_fails():
    """
    Ejercicio 10: Test de multiplicación.

    Inicialmente falló a propósito para demostrar cómo pre-commit hooks
    bloquean commits cuando hay tests que fallan.
    Ahora está corregido.
    """
    result = 5 * 3
    # ✅ CORREGIDO: 5 * 3 = 15 (antes esperaba 20)
